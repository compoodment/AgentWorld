...
| Ecology and weather | **Integrated but thin** | Renewable resources and seasons persist. Generated worlds have deterministic 32×32-tile weather regions; weather affects agents' local warmth/clothing/fire choices, travel fatigue and crop yields at the field. Recent rain and dry days produce a bounded three-day local soil-moisture estimate that can modestly improve or reduce food-crop yields. The top bar follows camera-local weather; World Info also shows nearby soil moisture | Soil moisture is a short derived estimate, not per-tile hydrology. Biome weighting, moving weather fronts and precipitation art remain unfinished. Broader ecosystems and balance also need work |
