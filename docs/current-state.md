...
| 3 | Playtest a six-minute day and custom 40-day/four-season year, with at most six hours of life from birth | The host still schedules one tick per real second; this preserved world has 1,440 ticks/day and 365 days/year. The HUD reads those saved values and offers date-order display, but the prototype aging override does not implement the chosen calendar. Existing saves/replay depend on these values. Make clock/calendar parameters versioned per world and migrate deliberately; do not reinterpret the live world's dates. |
