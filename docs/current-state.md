...
| Family, aging and death | **Integrated but thin** | Separate parental consent, preparation, dependent infants and actual caregiver food/warmth delivery; infants have no paid cognition. Household adults can volunteer to replace lost carers; older dependents accept/refuse independently. Fresh host-created worlds start with an empty camp and require four unrelated founders before time begins. They use six-minute days, a 40-day year, and day-based stages: child at day 3, adult at day 15, elder at day 45, death by day 60 from birth. The card shows age in days. A pause-only prototype aging override remains under Developer tools | Founder names and personalities are placeholders, not yet chosen by the models. Stage-specific social capability and lifespan balance need playtesting; legal guardianship and inheritance remain thin |
...
| Client presentation | **Playable** | Startup Main Menu with Continue, Settings, host pairing and Quit Game; shared stores, project phases/blockers, social notes, provider activity and compact per-inhabitant settings | New World and Load World are visibly unavailable until world creation and save selection actually exist. Prototype visuals; no dedicated economy/project management screen |
