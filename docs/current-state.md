...
| Map and movement | **Playable** | Deterministic Small/Medium generated maps with an empty base camp, rivers/lakes/ocean, no-build mountain/peak terrain, four-founder setup, camera-visible terrain drawing and a draggable top-left overview. Climate is saved separately from provisional sand/forest/snow ground appearances. Sparse resource sites extend beyond the camp and belong to their actual 64×64 chunks. The older 6×5 world remains selectable. Generated terrain travels in compact row-major owner observations | Surface and vegetation remain collapsed into a few ground kinds; biome/object catalogues and art are unfinished. Whole packed maps still resend every observation and saves still contain per-tile JSON. East/west wrap does not yet apply to all agent routes. Large/Huge/Mega exist only in compact geography generation |
...
| Ecology and weather | **Integrated but thin** | Renewable resources and seasons persist. Generated worlds have ground-based food, fiber, seed, stone and regrowing wood sites beyond the starter camp; Sparse/Normal/Abundant changes their count, shown in New World preview. Generated worlds have deterministic 32×32-tile weather regions weighted by saved local climate; weather affects agents' local warmth/clothing/fire choices, travel fatigue and crop yields at the field. Recent rain and dry days produce a bounded three-day local soil-moisture estimate that can modestly improve or reduce food-crop yields. The top bar follows camera-local weather; World Info also shows nearby soil moisture | Site distribution and abundance densities are provisional, not a full art/object catalogue. Soil moisture is a short derived estimate, not per-tile hydrology. Rich biome weighting, moving weather fronts and precipitation art remain unfinished. Broader ecosystems and balance also need work |
...
| Client presentation | **Playable** | Startup Main Menu with Continue, New World, Load World, Settings, pairing and Quit Game. New World previews its deterministic terrain and marked camp with balanced/uniform/dominant climate and Sparse/Normal/Abundant resource choices, then creates a paused camp; founder setup and Start World happen in-world. The pause menu owns Save World/Load Save. In-world panels cover shared stores, work, social notes and agent settings | Continent controls remain missing. Prototype visuals and no dedicated economy/project management screen |
...
| 2 | New World creates a map and empty base camp; four configured founders are added in-world, then Start World begins time | The signed host and Main Menu now preview, create and select separately saved Small/Medium worlds with initial climate-mode/family/latitude choices. Generated worlds open paused at an empty camp; founder placement and explicit Start World are shared with the previous development world. The five named size presets and 64×64 geography foundation exist, but deeper generation controls and scalable physical-map persistence are still missing; Large/Huge/Mega cannot be played yet. |
...
| 7 | Regional weather, bounded inventions and mods, cross-generation social life | Generated worlds now use local weather regions for survival, work and display, with a short rain-derived soil-moisture effect on crops; seasonal effects and data-only building proposals remain thin. Detailed hydrology/weather movement, the Mod Library, restricted scripted content, deep conversation/memory and full inheritance are not yet connected. |
